...
A self-directed 4-year cybersecurity learning path, running alongside my BTech:

- [x] Linux fundamentals (command line, permissions, scripting)
...
- GitHub: [@shaileshmhr975-tech](https://github.com/shaileshmhr975-tech)

---
⭐️ *Learning in public — feel free to follow along as I build this out.*
